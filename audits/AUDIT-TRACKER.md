...
| PERF-3 | Verify `SKIP_BOOT_DB_GUARDS=1` in the production Vercel env (B-PERF-02) | `OPEN` | Review #3 — owner/dashboard check. Keeps the ~70-statement boot-guard chain off cold starts. Can't read env over MCP. |
