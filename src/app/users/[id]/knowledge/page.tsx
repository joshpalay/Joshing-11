...
export default async function FriendKnowledgePage({ params }: FriendKnowledgePageProps) {
  ...
  return (
    <main className="mx-auto flex min-h-dvh max-w-2xl flex-col px-4 py-5">
      ...
      <header className="mb-5">
        ...
        <p className="text-muted-foreground mt-2 text-sm leading-6">{mindStatement}</p>
      </header>
