...
export default function DevNoonResetPage() {
  return (
    <main className="mx-auto flex min-h-dvh max-w-2xl flex-col px-4 pt-10 pb-28">
      ...
      <h1 className="mt-6 font-serif text-3xl leading-tight font-semibold">Trigger noon reset</h1>
      <p className="text-muted-foreground mt-2 text-sm">Simulate daily reset.</p>
