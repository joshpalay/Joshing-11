...
const { checkBankedQuestionsMock, dbMock, getDismissedDomainsMock, getFeedForUserMock, getSessionMock, state } = vi.hoisted(() => {
  ...
  const state = {
    questionRows: [] as Array<{
      id: string; questionText: string; answerText: string; creatorId: string; verified: boolean;
      explainerBrief: string | null; factualExplanation: string | null; canonicalSubcategory: string | null;
      broadCategory: string | null; category: string | null; calibratedDifficulty: string | null;
      llmDifficulty: string | null; difficultyEstimate: string | null;
    }>,
  ...
  return { checkBankedQuestionsMock, dbMock, getDismissedDomainsMock, getFeedForUserMock, getSessionMock, state };
});
