...
const { getSessionMock, getUserOnboardingProfileMock, refreshSessionOnboardingClaimMock } =
  vi.hoisted(() => ({
...
function makeRequest(query = '') {
  return new Request(`http://localhost/api/auth/refresh-onboarding-claim${query}`, {
    method: 'GET',
  });
}
