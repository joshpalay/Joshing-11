          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div className="relative">
              <textarea
                ...
                rows={5}
                className="min-h-[180px] w-full resize-none rounded-[var(--radius-md)] border border-[var(--cream-accent)] bg-[var(--brand-field)] px-4 py-3 text-base text-[var(--brand-ink)] focus:border-[var(--brand-navy)]"
              />
              {idea.trim() === '' ? (
                <span
                  aria-hidden="true"
