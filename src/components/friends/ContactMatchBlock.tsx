  ...
  if (!supportsContactsAPI()) {
    return (
      <section className="bg-card text-card-foreground rounded-2xl border p-4 shadow-sm">
        <h2 className="font-serif text-lg font-semibold">Find friends already on Joshing</h2>
        <p className="text-muted-foreground mt-1 text-sm leading-6">
          Your browser doesn&rsquo;t support automatic contact matching. You can still search by
          @handle or phone number (above), or send a friend an invite link.
        </p>
      </section>
    );
  }
  ...
  if (!discoverableByContacts) {
    return (
      <section className="bg-card text-card-foreground rounded-2xl border p-4 shadow-sm">
        <h2 className="font-serif text-lg font-semibold">Find friends already on Joshing</h2>
        <p className="text-muted-foreground mt-1 text-sm leading-6">
          Turn on contact matching to see which of your contacts are here. We hash your contacts on
          your device and never share them.
        </p>
        <Link
  ...
  return (
    <section className="bg-card text-card-foreground rounded-2xl border p-4 shadow-sm">
      ...
      {matches.length === 0 ? (
        <>
          <p className="text-muted-foreground mt-1 text-sm leading-6">
            We can check which of your phone contacts are here. We hash your contacts on your device
