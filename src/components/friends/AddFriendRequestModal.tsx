    ...
    <>
      ...
      >
        ...
        <textarea
          ...
          disabled={sending}
          className="border-[var(--accent-gold)] bg-[var(--brand-field)] text-foreground placeholder:text-muted-foreground w-full resize-none rounded-lg border p-3 text-sm focus:border-[var(--brand-navy)]"
        />
