    ...
    >
      ...
      <div className="flex gap-2">
        <input
          ...
          autoCapitalize="off"
          spellCheck={false}
          className="min-h-11 min-w-0 flex-1 rounded-[var(--radius-md)] border border-[var(--accent-gold)] bg-[var(--brand-field)] px-4 text-base text-[var(--text)] focus:border-[var(--brand-navy)] disabled:cursor-not-allowed disabled:opacity-60"
        />
        <button
          type="submit"
