...
import { DIFFICULTY_BASE_POINTS, PORTRAIT_DIFFICULTY_WEIGHT } from '@/server/mastery/constants';
...
export function creatorMasteryAwardForNthCorrect(
  ...
  const { basePoints, fullCreditWindow, reducedCreditWindow } =
    creatorMasteryWindowFromEmpiricalRate(correctCount, askedCount);
