...
export function toKnowledgeCardDomain(domain: DomainMastery): KnowledgeDomainCircle {
  return {
    canonicalSubcategory: domain.displayName,
...
export function topPointPositiveDomains(domains: DomainMastery[], limit = 5): DomainMastery[] {
  return [...domains]
