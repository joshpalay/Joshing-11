...
async function main() {
  ...
  if (missingFromDb.length > 0) {
    ...
    console.log(`✓ Inserted ${missingFromDb.length} entries into ${schema}.__drizzle_migrations`);
  }

  // --- apply: delete helper scripts
  const helpers = [join('scripts', 'check-ceremony-index.mjs'), join('scripts', 'apply-0032.mjs')];
