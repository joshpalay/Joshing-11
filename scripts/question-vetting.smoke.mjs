...
const approved = verdictToPublicStatus({
  status: 'approved',
  score: 0.82,
  reason: 'specific and verifiable',
});
...
const rejected = verdictToPublicStatus({
  status: 'rejected',
  score: 0.12,
  reason: 'factual: wrong answer',
});
...
const needsReview = verdictToPublicStatus({
  status: 'needs_review',
  score: null,
  reason: 'llm_error',
});
...
const needsReviewWithScore = verdictToPublicStatus({
  status: 'needs_review',
  score: 0.6,
  reason: 'unverifiable: niche claim',
});
